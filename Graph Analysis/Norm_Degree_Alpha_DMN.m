%%%
%
% Script which computes the Normalized Weighted Degree (in the alpha band) for the DMN network defined by Raichle. (https://doi.org/10.1146/annurev-neuro-071013-014030)
...
% Graph analysis: normalized weighted degree from AEC in the alpha range for the DMN network
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'DMN Normalized Degree (AEC Alpha 8 - 13)';
