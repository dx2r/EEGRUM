%%%
%
% Script which computes the Total Integration (in the beta band) for the network defined by Zhou and colleagues. (https://doi.org/10.1016/j.neuroimage.2019.116287)
...
% Graph analysis: total integration in the beta range for the Zhou network
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'Zhou Total Integration (AEC Beta 14 - 30)';
