%%%
%
% Script which computes the Normalized Weighted Degree (in the alpha band) for the network defined by Zhou and colleagues. (https://doi.org/10.1016/j.neuroimage.2019.116287)
...
% Graph analysis: normalized degree from AEC in the alpha range, network defined by Zhou et al. (2020)
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'Zhou Normalized Degree (AEC Alpha 8 - 13)';
    ...
    %%%
        ...
        analysis_choice_graph = "undirected weighted normalized degree";
        graph_varargin = {1};
