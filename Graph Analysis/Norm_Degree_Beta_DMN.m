%%%
%
% Script which computes the Normalized Weighted Degree (in the beta band) for the DMN network defined by Raichle. (https://doi.org/10.1146/annurev-neuro-071013-014030)
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'DMN Normalized Degree (AEC Beta 14 - 30)';
