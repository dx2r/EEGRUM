%%%
%
% Script which computes the Normalized Weighted Degree (in the beta band) for the network defined by Zhou and colleagues. (https://doi.org/10.1016/j.neuroimage.2019.116287)
...
% Graph analysis: normalized degree from AEC in the beta range for the DMN network
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'Zhou Normalized Degree (AEC Beta 14 - 30)';
