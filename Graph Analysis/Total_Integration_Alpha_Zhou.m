%%%
%
% Script which computes the Total Integration (in the alpha band) for the network defined by Zhou and colleagues. (https://doi.org/10.1016/j.neuroimage.2019.116287)
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        analysis_choice_graph = "total integration";
        graph_varargin = {1};
