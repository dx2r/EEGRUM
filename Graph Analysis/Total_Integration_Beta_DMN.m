%%%
%
% Script which computes the Total Integration (in the beta band) for the DMN network defined by Raichle. (https://doi.org/10.1146/annurev-neuro-071013-014030)
...
% Graph analysis: total integration from AEC in the beta range for the DMN network
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        graph_results_map_name = 'DMN Total Integration (AEC Beta 14 - 30)';
