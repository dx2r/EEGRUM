%%%
%
% Script which computes the Amplitude Envelope Correlation (in the alpha band) for the DMN network defined by Raichle. (https://doi.org/10.1146/annurev-neuro-071013-014030)
...
% FC analysis: AEC, alpha band (8 - 13 Hz), network defined by Raichle. (2015)
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        fc_results_map_name = 'DMN - AEC (Alpha 8 - 13)';
