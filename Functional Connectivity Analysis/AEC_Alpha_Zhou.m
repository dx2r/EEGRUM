%%%
%
% Script which computes the Amplitude Envelope Correlation (in the beta band) for the network defined by Zhou and colleagues. (https://doi.org/10.1016/j.neuroimage.2019.116287)
...
% FC analysis: AEC, alpha band (8 - 13 Hz), network defined by Zhou et al. (2020)
...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        fc_results_map_name = 'Zhou - AEC (Alpha 8 - 13)';
    ...
    %%%
        ...
        region_1 = 9;
        region_1_name = "Anterior Cingulate Cortex L";
        %region 2: gurys rectus R
        region_2 = [95 97];
        region_2_name = "Precuneus L";
        %region 3: dorsal medial prefrontal cortex L
        region_3 = [113 115];
        region_3_name = "Superior Temporal Gyrus L";
        %region 4: dorsal medial prefrontal cortex R
        region_4 = 1;
        region_4_name = "Angular Gyrus L";
